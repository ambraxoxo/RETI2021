...
public class ClientMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("[Client] Closing connection, Goodbye");
    }
    ...
    public static void clientConfig(InetSocketAddress address, Selector selector) {
        try(SocketChannel socketChannel = SocketChannel.open()) {
            ...
            System.out.println("[Client] Error opening socket channel: " + e.getMessage());
        }
    }
        ...
        while (iterator.hasNext()) {
            ...
            if (key.isReadable()) {
                ...
                try{
                    ...
                    System.out.println("[Client] Error decoding message: " + e.getMessage());
                }
            ...
            if (key.isWritable()) {
                try{
                    ...
                    System.out.println("[Client] Error reading user input: " + e.getMessage());
                }
            }
    ...
    private static void processWrite(SelectionKey key, String msg) {
        ...
        try{
            ...
            System.out.println("[Client] Error writing to socket channel: " + e.getMessage());
        }
        try{
            sChannel.register(key.selector(), SelectionKey.OP_READ);
        } catch (ClosedChannelException e) {
            System.out.println("[Client] Error registering channel: " + e.getMessage());
        }
    }
    ...
    private static String processRead(SelectionKey key) throws CharacterCodingException {
        ...
        try{
            ...
            System.out.println("[Client] Error reading from socket channel: " + e.getMessage());
        }
        buffer.flip();
    ...
    public static String getUserInput() throws IOException {
        ...
        System.out.print("[Client] " +promptMsg);
